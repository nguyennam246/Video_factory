...
const slideScripts = [
  "Sáu tuần, cổ phiếu PNJ mất hơn nửa giá, từ sáu mươi tám nghìn xuống dưới ba mươi mốt nghìn.",
  "Ngòi nổ: cựu giám đốc công ty con kiểm định đá quý bị khởi tố, vì hai mươi tám nghìn viên kim cương lậu và chứng thư giả.",
  "Thị trường hoảng loạn. Bảy phiên giảm sàn một tháng, bốn phiên cuối liền nhau, trắng bên mua.",
  "Người thường nhìn giá rơi. Nhà đầu tư giá trị hỏi như Buffett. Cỗ máy kiếm tiền có hỏng không?",
  "Ngành trang sức có tiền lệ đáng sợ. Năm chín mốt ở Anh, ông chủ hãng trang sức lớn nhất thế giới lỡ miệng chê hàng của chính mình là đồ rẻ tiền.",
  ...
  "Điểm khác quan trọng. Theo công bố, sai phạm nằm ở cá nhân tại công ty con, không phải cách công ty mẹ kiếm tiền. Nhưng đó là lời công ty, tòa chưa tuyên.",
